...
import com.example.yuefenginterviewproject.databinding.FragmentSubBestsellers02Binding

class SubBestsellers02Fragment : Fragment() {
    private lateinit var binding: FragmentSubBestsellers02Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSubBestsellers02Binding.inflate(inflater, container, false)
    ...
    private fun setupRecyclerView() {
        ...
        binding.SubBestsellers02RecyclerView.apply {
            layoutManager = LinearLayoutManager(requireContext()) // 纵向列表布局
            adapter = this@SubBestsellers02Fragment.adapter
        }
    }

    private fun observeData() {
        baseHomeModel.mySubBestsellers02List.observe(viewLifecycleOwner) { itemList ->
