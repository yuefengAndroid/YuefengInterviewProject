...
class HomeBanner5Adapter (val frag: Fragment, var list: ArrayList<HomeBannerEntity>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ViewHolder(LayoutInflater.from(frag.context).inflate(R.layout.item_home_banner05, parent, false))
    }
