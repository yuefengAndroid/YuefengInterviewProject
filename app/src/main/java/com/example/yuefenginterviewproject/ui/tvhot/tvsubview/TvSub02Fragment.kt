...
import com.example.yuefenginterviewproject.databinding.FragmentTvSub02Binding

class TvSub02Fragment : Fragment() {
    private lateinit var binding: FragmentTvSub02Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTvSub02Binding.inflate(inflater, container, false)
    ...
    private fun setupRecyclerView() {
        ...
        binding.SubBestsellers01RecyclerView.apply {
            ...
            adapter = this@TvSub02Fragment.adapter
        }
    }
