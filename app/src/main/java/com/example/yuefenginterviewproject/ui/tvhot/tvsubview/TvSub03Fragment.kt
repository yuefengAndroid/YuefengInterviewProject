...
import com.example.yuefenginterviewproject.databinding.FragmentTvSub03Binding

class TvSub03Fragment : Fragment() {
    private lateinit var binding: FragmentTvSub03Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTvSub03Binding.inflate(inflater, container, false)
    ...
    private fun setupRecyclerView() {
        ...
        binding.SubBestsellers01RecyclerView.apply {
            ...
            adapter = this@TvSub03Fragment.adapter
        }
    }
