...
class SubEvent01ViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun loadSubHotData() {
        subHotRepository.getSubHotData(object : SubEvent01Repository.OnSubHotFinish {
